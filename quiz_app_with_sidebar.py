...
# Scenario viewer in sidebar
with st.sidebar:
    st.markdown("---")
    st.subheader("📘 Scenario Lookup")
    scenario_keys = sorted(scenarios.keys())
    selected_scenario = st.selectbox("View Scenario", [""] + scenario_keys)
